...
//		mLoadingBitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.ic_ebook_pdf);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		aq.id(R.id.ThumbnailNumber).text("Page " + (position + 1));

		/*if (mPage == position) {
			aq.id(R.id.ThumbnailLayoutView).background(R.color.bg_thumbnail_selected);
		...
		if (mPage == position) {
			aq.id(R.id.ThumbnailLayoutView).background(R.color.bg_thumbnail_selected);
			//aq.id(R.id.ThumbnailNumber).textColorId(R.color.white);
			aq.id(R.id.ThumbnailNumber).getTextView().setSelected(true);
		} else {
			//aq.id(R.id.ThumbnailLayoutView).background(R.drawable.button);
			aq.id(R.id.ThumbnailLayoutView).background(R.drawable.button);
			//aq.id(R.id.ThumbnailNumber).textColorId(R.color.text_thumb_selector);
			aq.id(R.id.ThumbnailNumber).getTextView().setSelected(false);
		}
